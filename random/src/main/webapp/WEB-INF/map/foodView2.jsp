...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-2 sidenav">
      <div class="well">
        <button id="search" type="button" class="btn btn-success">주변 음식점 검색</button>
      </div>
      <div class="well">
        <button id="reset" type="button" class="btn btn-success">목록 초기화</button>
      </div>
       <div class="well">
        <button id="random" type="button" class="btn btn-success">음식점 랜덤 선택</button>
      </div>
      <div>
      	<ul id="foodList">
